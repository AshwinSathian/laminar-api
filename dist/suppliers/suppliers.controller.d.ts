...
export declare class SuppliersController {
    ...
    findAll(): Promise<import("../schemas/supplier.schema").Supplier[]>;
    ...
    remove(id: string): Promise<import("mongoose").Document<unknown, {}, import("../schemas/supplier.schema").Supplier> & import("../schemas/supplier.schema").Supplier & {
